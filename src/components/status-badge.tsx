...
export type Statut = "done" | "in_progress" | "postponed" | "paused" | "blocked";
...
const CONFIG: Record<Statut, { label: string; className: string; dot: string }> = {
  ...
  paused: { label: "Suspendue", className: "bg-slate-50 text-slate-700 border-slate-200", dot: "bg-slate-400" },
  blocked: { label: "Bloquée", className: "bg-orange-50 text-orange-700 border-orange-200", dot: "bg-orange-500" },
};
